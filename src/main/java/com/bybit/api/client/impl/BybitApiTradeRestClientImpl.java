...
public class BybitApiTradeRestClientImpl implements BybitApiTradeRestClient {
    ...
    @Override
    public GenericResponse<OrderResult> cancelBatchOrder(BatchOrderRequest batchOrderRequest) {
    ...
    @Override
    public GenericResponse<OrderResult> getTradeHistory(TradeOrderRequest order) {
